...
import { idlFactory } from './book_nft.did.js';
export { idlFactory } from './book_nft.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BOOK_NFT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./book_nft.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the book_nft canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./book_nft.did.js")._SERVICE>}
 */
export const book_nft = createActor(canisterId);
